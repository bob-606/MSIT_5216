...
Future enhancements could integrate memoization to cache category sizes (Cormen et al., 2009) or adopt graph databases for persistent storage of hierarchical relationships (Robinson et al., 2015). Additionally, implementing thread-safe mutations would align with concurrent access patterns in multi-user library systems (Goetz, 2006). 
